...
CREATE TABLE IF NOT EXISTS users (
    ...
    CONSTRAINT uc_users_email_address UNIQUE (
        email_address
    )
);

CREATE TABLE IF NOT EXISTS rating_mpa (
    rating_mpa_id integer GENERATED BY DEFAULT AS IDENTITY,
    name varchar NOT NULL,
...
ALTER TABLE film ADD CONSTRAINT IF NOT EXISTS fk_film_rating_mpa_id FOREIGN KEY(rating_mpa_id) 
